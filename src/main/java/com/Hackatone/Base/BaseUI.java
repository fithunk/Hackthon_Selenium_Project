...
public class BaseUI {
	...
	public void invokeBrowser() {
		try {
			String propPath = "C:\\Users\\Subash Yadav\\Downloads\\Display_Bookshelves\\src\\test\\resources\\ObjectRepository\\projectConfig.properties";
	...
	public void chooseManualPriceWithSlider(String xpathKey, String sliderXpath) throws InterruptedException {
		try {
			...
			WebElement slider = getElement(sliderXpath);
			act.clickAndHold(slider);
			Thread.sleep(2000);
			act.moveByOffset(-208, 0);
